      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="flex justify-center">
          <div className="mr-4">
            ...
            <div className="flex mb-4">
              <input
                ...
                placeholder="Game ID"
              />
              <button onClick={joinGame} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-r-lg">
                Join
              </button>
            </div>
          </div>
          <div className="ml-4">
            ...
            <div className="flex justify-center">
              <button onClick={newGame} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg">
                Create
              </button>
            </div>
          </div>
